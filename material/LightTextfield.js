...
const $4f02f266504ee787$var$LightTextfield = ({ label: label , variant: variant , color: color , type: type  })=>{
    const colors = [
        "lightblue",
        "lightgreen",
        "lightpurple",
    ...
    return /*#__PURE__*/ (0, $9E8Zr$reactjsxruntime.jsx)("input", {
        ...
        className: variant === "outline" ? (0, (/*@__PURE__*/$parcel$interopDefault($24a5123f37d03349$exports))).textField : (0, (/*@__PURE__*/$parcel$interopDefault($24a5123f37d03349$exports))).textFieldDefault,
